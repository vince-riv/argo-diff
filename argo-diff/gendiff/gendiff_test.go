...
func init() {
	...
	curManifests = append(curManifests, "{\"apiVersion\":\"traefik.containo.us/v1alpha1\",\"kind\":\"IngressRoute\",\"metadata\":{\"labels\":{\"argocd.argoproj.io/instance\":\"argo-diff\"},\"name\":\"argocd-diff\",\"namespace\":\"argocd\"},\"spec\":{\"entryPoints\":[\"websecure\"],\"routes\":[{\"kind\":\"Rule\",\"match\":\"Host(`argocd.k3s.dummy.domain`) \\u0026\\u0026 HeadersRegexp(`X-GitHub-Event`, `.*`) \\u0026\\u0026 PathPrefix(`/webhook`)\",\"priority\":100,\"services\":[{\"name\":\"argo-diff\",\"port\":8080}]}],\"tls\":{\"certResolver\":\"default\"}}}")
	...
	newManifests = append(newManifests, "{\"apiVersion\":\"traefik.containo.us/v1alpha1\",\"kind\":\"IngressRoute\",\"metadata\":{\"labels\":{\"argocd.argoproj.io/instance\":\"argo-diff\"},\"name\":\"argocd-diff\",\"namespace\":\"argocd\"},\"spec\":{\"entryPoints\":[\"websecure\"],\"routes\":[{\"kind\":\"Rule\",\"match\":\"Host(`argo-diff.k3s.dummy.domain`) \\u0026\\u0026 HeadersRegexp(`X-GitHub-Event`, `.*`) \\u0026\\u0026 PathPrefix(`/webhook`)\",\"priority\":100,\"services\":[{\"name\":\"argo-diff\",\"port\":8080}]}],\"tls\":{\"certResolver\":\"default\"}}}")
}
